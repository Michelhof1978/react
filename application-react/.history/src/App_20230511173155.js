...
function App() {//Cette fonction est un composant
  ...
  const [monState, setMonState] = useState(10);//On appelle cela du destructuring, ici on crée une constante entre crochets à partir de ce que retourne useState en tableau monState à l index 0 et setMonState à l'index 1
    ...
    modifier la valeur de "monState" ultérieurement.En résumé, ce code initialise une variable d'état "monState"
     avec une valeur de départ de 10 et extrait la fonction "setMonState" qui permet de mettre à jour cette valeur. La ligne suivante affiche cette fonction dans la console.
