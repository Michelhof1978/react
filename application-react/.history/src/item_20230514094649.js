...
function Item(props){//On crée un composant avec la propriété props et cela va nous retourner un objet avec des propriétés qui lui sera donné par l élément parent qui est App.js ds ce cas là
    ...
    <h1>{props.number}</h1> {/*On veut que les Item props.txt affiché ds l élément parent App.js soient en H1
    <h1>{props.number}</h1>                      //Pas besoins de mettre des paranthèses pour return quand il y a qu'un seul élément */}
