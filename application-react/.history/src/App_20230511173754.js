...
// --------------------
  const [monState, setMonState] = useState(10);//On appelle cela du destructuring, ici on crée une constante entre crochets à partir de ce que retourne useState en tableau monState à l index 0 et setMonState à l'index 1, à noter que les 2 index du tableau, on peut les nommer comme on veut
