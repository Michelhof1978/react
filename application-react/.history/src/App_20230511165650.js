...
function App() {//Cette fonction est un composant
  ...
  const [monState, setMonState] = useState(10);//On appelle cela du destructuring, ici on crée une constante entre crochets à partir de ce que retourne useState avec ce qu'il y a entre crochets 
