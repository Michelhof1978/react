...
function App() {//Cette fonction est un composant
  ...
  const [monState, setMonState] = useState(10);//On appelle cela du destructuring, ici on crée une constante entre crochets à partir de ce que retourne useState en tableau monState à l index 0 et setMonState à l'index 1
    ...
    Ce code utilise React pour créer une variable d'état (state) appelée "monState" avec une valeur initiale de 10.
     ...
     les composants fonctionnels. Lorsque vous appelez `useState(10)`, la fonction `useState` retourne un tableau avec deux éléments. Le premier élément, "monState", est la variable qui représente l'état et qui contient la valeur actuelle. Le deuxième élément, "setMonState", est une fonction qui permet de mettre à jour la valeur de l'état.
