...
// ----------------------
    return (
     <div className="App">  {/* Ce n est pas du html mais du jsx, ici on ne mets pas class mais className pour du jsx*/}
      <h1>Hello state : {monState} </h1> {/*on affiche les données du state ds le contenu App*/}
     <button onClick={modifyState}>Change state</button>On ajoute un événement au bouton, par contre en jsx, on rajoute on suivi de la majuscule, entre les accolades, on attents une fonction ici modify
