...
function App() {//Cette fonction est un composant
  ...
  const [monState, setMonState] = useState(10);//On appelle cela du destructuring, ici on crée une constante à partir de ce que retourne us avec ce qu'il y a entre crochets 
